...
const BookingList = () => {
  ...
  // later api calls will go here
  const listedCars = ['Model 1', 'Model 2', 'Model 3', 'Model 4', 'Model 5', 'Model 6'];
  const listedUsers = ['person 1', 'person 2', 'person 3', 'person 4', 'person 5'];
  const bookingConfirmations = [
    'person 1 booked Model 1 on 2022-01-01',
    'person 2 booked Model 2 on 2022-01-02',
    'person 3 booked Model 3 on 2022-01-03',
    'person 4 booked Model 4 on 2022-01-04',
    'person 5 booked Model 5 on 2022-01-05'
  ];
